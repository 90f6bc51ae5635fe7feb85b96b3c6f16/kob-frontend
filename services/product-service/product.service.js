export default (axios) => ({
    ...
    getProductCount: (data) => axios.get(`/api/product-count/${data.count_category},${data.count_keyword},${data.count_brand},${data.count_min},${data.count_max}`),
    ...
    getProductCategoryByCode: (data) => axios.get(`/api/category/${data.category_page},${data.category_code},${data.category_brand},${data.category_min},${data.category_max}`),
