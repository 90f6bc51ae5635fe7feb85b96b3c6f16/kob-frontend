<template>
  <b-list-group class="rounded-0">
    <b-list-group-item
      :variant="active == 'account-profile' ? 'secondary' : ''"
    ...
    <b-list-group-item
      :variant="active == 'account-address' ? 'secondary' : ''"
    ...
    <b-list-group-item
      :variant="active == 'account-password' ? 'secondary' : ''"
    ...
    <b-list-group-item
      :variant="active == 'purchase' ? 'secondary' : ''"
      :href="`/user/purchase`"
    >
