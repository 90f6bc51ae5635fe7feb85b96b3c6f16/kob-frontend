<template>
                          ...
                          ">
                            ...
                            <li style="margin: 0 0.5em 0 0.5em;">
                                <nuxt-link class="btn btn-outline-primary"
                                    ...
                                    :to="{ path: `/product/page/${pages + 1}`, query: { keyword: keyword, brand: brand, min: min, max: max } }">{{
    pages
                                    + 1}}</nuxt-link>
                            </li>
                            <li style="margin: 0 0 0 0.5em;">
    ...
    pages
                            ...
                            <li style="margin: 0 0.5em 0 0.5em;">
                                <nuxt-link class="btn btn-outline-primary"
                                    style=" margin-left: 4.335%; margin-right: 4.335%;"
                                    :to="{ path: `/product/page/${pages + 2}`, query: { keyword: keyword, brand: brand, min: min, max: max } }">{{
    pages
                                    + 2}}</nuxt-link>
                            </li>
                            <li style="margin: 0 0 0 0.5em;">
    ...
    pages
                            ...
                            <li style="margin: 0 0.5em 0 0.5em;">
                                <nuxt-link class="btn btn-outline-primary"
                                    style=" margin-left: 4.335%; margin-right: 4.335%;"
                                    :to="{ path: `/product/page/${pages + 3}`, query: { keyword: keyword, brand: brand, min: min, max: max } }">{{
    pages
                                    + 3}}</nuxt-link>
                            </li>
                            <li style="margin: 0 0 0 0.5em;">
    ...
    pages
                            ...
                            <li style="margin: 0 0.5em 0 0.5em;">
                                <nuxt-link class="btn btn-outline-primary"
                                    style=" margin-left: 4.335%; margin-right: 4.335%;"
                                    :to="{ path: `/product/page/${pages + 4}`, query: { keyword: keyword, brand: brand, min: min, max: max } }">{{
    pages
                                    + 4}}</nuxt-link>
                            </li>
                            <li style="margin: 0 0 0 0.5em;">
