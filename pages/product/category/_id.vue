        ...
        <b-col cols="3" style="margin: 0 0 0 -1em">
            ...
            ">
              ...
              " v-for="brand in brands" :key="brand.product_brand_code">
                        <input type="radio" id="id1" :name="`${brand.product_brand_code}`" :value="`${brand.product_brand_code}`" v-model="checkedNames" style="margin: 0 5px 0 10px" @click="check($event)" />
            ...
            " v-for="count in counts" :key="count">
                ...
                <div v-if="Math.round(count.product_count) == 2">
                    <ul v-if="pages == 1" style="margin-top: 1em;
                        ...
                        <li style="margin: 0 0.5em 0 0.5em;">
                            <nuxt-link class="btn btn-outline-primary" style=" margin-left: 4.335%; margin-right: 4.335%;" :to="{ path: `/product/category/page/${pages + 1}`, query: { category: category, brand: brand, min: min, max: max  }}">{{pages + 1}}</nuxt-link>
                        </li>
                        <li style="margin: 0 0 0 0.5em;">
                            <nuxt-link class="btn btn-outline-primary" style="float: right;" :to="{ path: `/product/category/page/${pages + 1}`, query: { category: category, brand: brand, min: min, max: max  }}">
                                <font-awesome-icon :icon="['fas', 'angle-right']" style="color: #555555; font-size: 10pt" />
                            </nuxt-link>
                        </li>
                    </ul>
                ...
                <div v-if="Math.round(count.product_count) == 3">
                    <ul v-if="pages == 1" style="margin-top: 1em;
                        ...
                        <li style="margin: 0 0.5em 0 0.5em;">
                            <nuxt-link class="btn btn-outline-primary" style=" margin-left: 4.335%; margin-right: 4.335%;" :to="{ path: `/product/category/page/${pages + 2}`, query: { category: category, brand: brand, min: min, max: max  }}">{{pages + 2}}</nuxt-link>
                        </li>
                        <li style="margin: 0 0 0 0.5em;">
                            <nuxt-link class="btn btn-outline-primary" style="float: right;" :to="{ path: `/product/category/page/${pages + 1}`, query: { category: category, brand: brand, min: min, max: max  }}">
                                <font-awesome-icon :icon="['fas', 'angle-right']" style="color: #555555; font-size: 10pt" />
                ...
                <div v-if="Math.round(count.product_count) == 4">
                    <ul v-if="pages == 1" style="margin-top: 1em;
                        ...
                        <li style="margin: 0 0.5em 0 0.5em;">
                            <nuxt-link class="btn btn-outline-primary" style=" margin-left: 4.335%; margin-right: 4.335%;" :to="{ path: `/product/category/page/${pages + 3}`, query: { category: category, brand: brand, min: min, max: max  }}">{{pages + 3}}</nuxt-link>
                        </li>
                        <li style="margin: 0 0 0 0.5em;">
                            <nuxt-link class="btn btn-outline-primary" style="float: right;" :to="{ path: `/product/category/page/${pages + 1}`, query: { category: category, brand: brand, min: min, max: max  }}">
                                <font-awesome-icon :icon="['fas', 'angle-right']" style="color: #555555; font-size: 10pt" />
                ...
                <div v-if="Math.round(count.product_count) == 5 ">
                    ...
                    ">
                        ...
                        <li style="margin: 0 0.5em 0 0.5em;">
                            <nuxt-link class="btn btn-outline-primary" style=" margin-left: 4.335%; margin-right: 4.335%;" :to="{ path: `/product/category/page/${pages + 4}`, query: { category: category, brand: brand, min: min, max: max  }}">{{pages + 4}}</nuxt-link>
                        </li>
                        <li style="margin: 0 0 0 0.5em;">
                            <nuxt-link class="btn btn-outline-primary" style="float: right;" :to="{ path: `/product/category/page/${pages + 1}`, query: { category: category, brand: brand, min: min, max: max  }}">
                                <font-awesome-icon :icon="['fas', 'angle-right']" style="color: #555555; font-size: 10pt" />
                    ...
                    ">
                        <li style="margin: 0 0.5em 0 0;">
                            <nuxt-link class="btn btn-outline-primary" style=" margin-left: 4.335%; margin-right: 4.335%;" :to="{ path: `/product/category/page/${pages -1}`, query: { category: category, brand: brand, min: min, max: max  }}">
                                <font-awesome-icon :icon="['fas', 'angle-left']" style="color: #555555; font-size: 10pt" />
                            </nuxt-link>
                        </li>
                        <li style="margin: 0 0.5em 0 0.5em;">
                ...
                <div v-if="Math.round(count.product_count) > 5 ">
                    ...
                    <ul v-if="pages > 3 && pages != Math.round(count.product_count)-2 && pages != Math.round(count.product_count)-1 && pages != Math.round(count.product_count)" style="margin-top: 1em;
                              justify-content: center;
                              list-style-type: none;
                              width: 100%;
                              display: flex;
