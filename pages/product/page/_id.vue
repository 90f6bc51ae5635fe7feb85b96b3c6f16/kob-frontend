<template>
    <div>
        ...
        <b-row class="row-content" style="padding-top: 30px">
            ...
            <b-col class="col-product">
                <b-col class="card-product" sm="12" md="3" v-for="(product, idx) in products" :key="'D' + idx">
                          ...
                          ">
                            ...
                            <li style="margin: 0 0.5em 0 0.5em;">
                                <nuxt-link class="btn btn-outline-primary"
                                    ...
                                    :to="{ path: `/product/page/${pageNo + 1}`, query: { keyword: keyword, brand: brand, min: min, max: max } }">{{
    pageNo
                                    + 1}}</nuxt-link>
                            </li>
                            <li style="margin: 0 0 0 0.5em;">
    ...
    pageNo
                            ...
                            <li style="margin: 0 0.5em 0 0.5em;">
                                <nuxt-link class="btn btn-outline-primary"
                                    style=" margin-left: 4.335%; margin-right: 4.335%;"
                                    :to="{ path: `/product/page/${pageNo + 2}`, query: { keyword: keyword, brand: brand, min: min, max: max } }">{{
    pageNo
                                    + 2}}</nuxt-link>
                            </li>
                            <li style="margin: 0 0 0 0.5em;">
    ...
    pageNo
                            ...
                            <li style="margin: 0 0.5em 0 0.5em;">
                                <nuxt-link class="btn btn-outline-primary"
                                    style=" margin-left: 4.335%; margin-right: 4.335%;"
                                    :to="{ path: `/product/page/${pageNo + 3}`, query: { keyword: keyword, brand: brand, min: min, max: max } }">{{
    pageNo
                                    + 3}}</nuxt-link>
                            </li>
                            <li style="margin: 0 0 0 0.5em;">
    ...
    pageNo
                            ...
                            <li style="margin: 0 0.5em 0 0.5em;">
                                <nuxt-link class="btn btn-outline-primary"
                                    style=" margin-left: 4.335%; margin-right: 4.335%;"
                                    :to="{ path: `/product/page/${pageNo + 4}`, query: { keyword: keyword, brand: brand, min: min, max: max } }">{{
    pageNo
                                    + 4}}</nuxt-link>
                            </li>
                            <li style="margin: 0 0 0 0.5em;">
    ...
    pageNo
                        ...
                        <ul v-if="pageNo > 3 && pageNo != Math.round(count.product_count) - 2 && pageNo != Math.round(count.product_count) - 1 && pageNo != Math.round(count.product_count)"
