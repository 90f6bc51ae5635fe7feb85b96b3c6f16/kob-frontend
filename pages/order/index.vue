<template>
  <div>
    <b-row>
      <b-col class="title-product">MY ORDER</b-col>
    </b-row>
    <b-row style="padding-top: 30px">
      <b-col cols="12" style="border: 0.2px solid #e5e5e5">
        ...
        <div
          style="padding: 10px; border-bottom: 1px solid #ccc !important"
        ...
        >
          <b-row>
            <b-col cols="1">
              <b-card-img
                :src="`https://placeimg.com/480/480/any?1`"
                style="max-width: 60px; margin: 10px"
                alt="Image"
                class="rounded-0"
              ></b-card-img>
            </b-col>
