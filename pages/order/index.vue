...
export default {
    ...
    mounted() {
        ...
        alert(JSON.parse(this.$cookies.get('user')))
    ...
    methods: {
        ...
        setOrderCode(value, order) {
            ...
            this.url = 'https://rvscs-develop.com/km-korat-web/slip/' + order.order_slip
        ...
        async handleSubmit(status) {
            ...
            try {
                if (status == 'customer_request_cancel') {
                    await this.$axios.post('https://rvscs-develop.com/km-korat-web/api/order-status-update', {
                    ...
                    if (this.file != null && this.file != '' && this.order_slip_date != '' && this.order_slip_time != '' && this.order_code != '') {
                        ...
                        await this.$axios.post('https://rvscs-develop.com/km-korat-web/api/upload-slip', formData, {
                            headers: {
                            ...
                            .then(async (response) => {
                                ...
                                if (response.data == "error") {
                                    ...
                                    if (this.order_slip != '') {
                                        ...
                                        await this.$axios.post('https://rvscs-develop.com/km-korat-web/api/order-slip-update', {
                                            order_status: this.order_status,
