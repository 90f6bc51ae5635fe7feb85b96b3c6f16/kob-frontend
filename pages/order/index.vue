<template>
    <div>
        ...
        <b-modal id="modal-1" title="แจ้งหลักฐานการโอน" @ok="handleSubmit('request_check_slip')" centered>
            <div id="preview" v-if="url != 'https://141.98.19.44:6901/slip/'">
...
export default {
    ...
    methods: {
        ...
        setOrderCode(value, order) {
            ...
            this.url = 'https://141.98.19.44:6901/slip/' + order.order_slip
        ...
        async handleSubmit(status) {
            ...
            try {
                if (status == 'customer_request_cancel') {
                    await this.$axios.post('https://141.98.19.44:6901/api/order-status-update', {
                    ...
                    if (this.file != null && this.file != '' && this.order_slip_date != '' && this.order_slip_time != '' && this.order_code != '') {
                        ...
                        await this.$axios.post('https://141.98.19.44:6901/api/upload-slip', formData, {
                            headers: {
                            ...
                            .then(async (response) => {
                                ...
                                if (response.data == "error") {
                                    ...
                                    if (this.order_slip != '') {
                                        ...
                                        await this.$axios.post('https://141.98.19.44:6901/api/order-slip-update', {
                                            order_status: this.order_status,
