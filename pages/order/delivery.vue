<template>
  <div class="pb-3">
    ...
    <div class="mt-4" v-for="(order, index) in orders" :key="index">
      <div v-if="order.order_status == 'request_check_slip' ||
            ...
            <b-col cols="12" md="6">
              <div class="px-3 pb-3 pt-sm-3 bg-light-gray text-sm-right">
                <a v-b-modal.modal-2 @click="setOrderCode(order.order_code, order)">
                  <span style="color: #f8b708" v-if="order.order_status == 'request_check_slip' ||
                    order.order_status == 'request_check_track'
                    ">
    ...
    <div v-if="deliveryordercount == 0" class="d-flex flex-column align-items-center justify-content-center"
      style="height: 600px">
