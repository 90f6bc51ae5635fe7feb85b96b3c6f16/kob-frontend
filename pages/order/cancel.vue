<template>
  <div class="pb-3">
      ...
      <b-col class="">
        <div class="row-header-content d-flex justify-content-between align-items-center">
          <nuxt-link active-class="" :to="{ path: `/order` }"
            class="header d-flex justify-content-center align-items-center" style="width: 100%; height: 50px">
            ทั้งหมด
          ...
          <nuxt-link :to="{ path: `/order/payment` }" class="header d-flex justify-content-center align-items-center"
            style="width: 100%; height: 50px">ที่ต้องชำระ
            <span class="notification-badge" v-if="paymentordercount > 0">({{ paymentcount }})</span>
          </nuxt-link>
          ...
          <nuxt-link :to="{ path: `/order/cancel` }" class="header d-flex justify-content-center align-items-center"
            style="width: 100%; height: 50px">ยกเลิก</nuxt-link>
    ...
    <div class="mb-4" v-for="(order, index) in orders" :key="index">
      <div class="mt-4" v-if="order.order_status == 'cancel' ||
    ...
    <div v-if="cancelordercount == 0" class="d-flex flex-column align-items-center justify-content-center"
      style="height: 600px">
