<template>
  <div class="pb-3">
      ...
      <b-col class="">
        <div class="row-header-content d-flex justify-content-between align-items-center">
          ...
          <nuxt-link :to="{ path: `/order/success` }" class="header d-flex justify-content-center align-items-center"
            style="width: 100%; height: 50px">สำเร็จแล้ว</nuxt-link>
    ...
    <div class="mt-4" v-for="(order, index) in orders" :key="index">
      <div v-if="order.order_status == 'success'" style="border: 1px solid #e5e5e5">
    ...
    <div v-if="successordercount == 0" class="d-flex flex-column align-items-center justify-content-center"
      style="height: 600px">
